...
function batchDelivery(request, sender, sendResponse) {
    chrome.tabs.create({
        url: 'http://' + targetUrl,  //正式
        selected: true,
        pinned: false
    }, function (tab) {
...
chrome.extension.onRequest.addListener(function (request, sender, sendResponse) {
    if (request.type == "batch_delivery") {
        batchDelivery(request, sender, sendResponse);
    } else if (request.type == "getList") {
        getList(request, sender, sendResponse);
    } else if(request.type == "get_tracking_number"){
